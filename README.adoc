...
Not the http://hasthelargehadroncolliderdestroyedtheworldyet.com/[Large Hadron Collider] but a neat tool to generator the linear Hamming Code that is perfect for your needs.
